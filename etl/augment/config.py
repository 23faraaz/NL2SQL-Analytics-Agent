...
MIN_VARIANTS_PER_PRODUCT = int(os.getenv("ETL_MIN_VARIANTS_PER_PRODUCT", "1"))
MAX_VARIANTS_PER_PRODUCT = int(os.getenv("ETL_MAX_VARIANTS_PER_PRODUCT", "3"))
...
MIN_MARKUP_MULTIPLIER = float(os.getenv("ETL_MIN_MARKUP_MULTIPLIER", "1.4"))
MAX_MARKUP_MULTIPLIER = float(os.getenv("ETL_MAX_MARKUP_MULTIPLIER", "2.5"))
