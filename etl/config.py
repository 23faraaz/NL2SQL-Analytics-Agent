...
RAW_DATA_DIR = Path(os.environ.get("OLIST_RAW_DATA_DIR", DATA_DIR / "raw"))
PROCESSED_DATA_DIR = Path(
    os.environ.get("OLIST_PROCESSED_DATA_DIR", DATA_DIR / "processed")
)
GENERATED_DATA_DIR = Path(
    os.environ.get("OLIST_GENERATED_DATA_DIR", DATA_DIR / "generated")
)
