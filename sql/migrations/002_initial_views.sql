...
CREATE OR REPLACE VIEW commerce.current_inventory AS
SELECT
    pv.variant_id,
    pv.sku,
    p.product_id,
...
CREATE OR REPLACE VIEW commerce.order_financials AS
WITH item_totals AS (
    SELECT
        oi.order_id,
...
CREATE OR REPLACE VIEW commerce.customer_lifetime_metrics AS
...
CREATE OR REPLACE VIEW commerce.monthly_sales_metrics AS
SELECT
    DATE_TRUNC(
        'month',
        ofn.order_date
...
CREATE OR REPLACE VIEW commerce.product_performance AS
...
CREATE OR REPLACE VIEW commerce.refund_metrics AS
SELECT
    DATE_TRUNC(
        'month',
        r.refund_date
...
CREATE OR REPLACE VIEW commerce.inventory_velocity AS
